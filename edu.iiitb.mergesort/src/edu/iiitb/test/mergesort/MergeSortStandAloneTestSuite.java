...
/**
 * Test Suite used to test all the stand alone test cases only. This test suite
 * runs with {@link org.junit.experimental.categories.Categories} instead of the
...
@ExcludeCategory(RegressionTest.class)
public class MergeSortStandAloneTestSuite {
